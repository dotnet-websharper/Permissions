...
function Main(){
  const permissionStatus=_c_1.Create_1("");
  const permissions=globalThis.navigator.permissions;
  const s=permissionStatus.View;
  const t=new _c_3("New_1");
  const t_1=(t.h.push(EventQ2(t.k, "checkgeolocationpermission", () => t.i, () => {
    const _3=null;
    Start(Delay(() => {
      const permissionName="geolocation";
      let _4=(permissions.query({name:permissionName}).then((result) => permissionStatus.Set(String(permissionName)+" permission: "+String(result.state))))["catch"](() => permissionStatus.Set("Permission "+String(permissionName)+" not supported"));
      let _5=AsAsync(_4);
      return Bind(_5, () => Return(null));
    }), null);
  })),t);
  const this_1=(t_1.h.push(EventQ2(t_1.k, "requestgeolocation", () => t_1.i, () => {
    globalThis.navigator.geolocation.getCurrentPosition((position) => permissionStatus.Set("Latitude: "+String(position.coords.latitude)+", Longitude: "+String(position.coords.longitude)), (error) => permissionStatus.Set("Geolocation error: "+String(error.message)));
  })),t_1);
  const b=(this_1.h.push(new _c_7("status", s)),this_1);
...
let _c_1=Lazy((_i) => class Var extends _c {
  ...
  static Create_1(v){
    return new _c_5(false, {s:Ready(v, [])}, v);
  }
  static { }
});
...
function CompleteHoles(key, filledHoles, vars){
  ...
  return[append(filledHoles, choose((_1) => {
    ...
    if(filledVars.Contains(name))return null;
      ...
      }):ty===4?_c_12.GetOrAddHoleFor(key, name, () => new _c_17(name, _c_1.Create_1([]))):ty===5?_c_12.GetOrAddHoleFor(key, name, () => new _c_18(name, _c_1.Create_1(Some(globalThis.document.querySelector("[ws-dom="+name+"]"))))):ty===6?_c_12.GetOrAddHoleFor(key, name, () => {
        const o=d==null?null:Some(d.$0);
        let _2=_c_1.Create_1(o==null?[]:o.$0);
...
let _c_7=Lazy((_i) => {
  Force(_c_6);
  return class TextView extends _c_6 {
    static {
      _c_7=_i(this);
    }
    name;
...
let _c_12=Lazy((_i) => class TemplateInitializer extends _c {
  ...
  static {
    _c_12.initialized=new _c_10("New_5");
    _c_12.instances=new _c_10("New_5");
  }
});
let _c_13=Lazy((_i) => {
  Force(_c_6);
...
let _c_20=Lazy((_i) => class Exception extends _c {
  static {
    _c_20=_i(this);
  }
});
...
let _c_22=Lazy((_i) => class Scheduler extends _c {
  static {
    _c_22=_i(this);
  }
  idle;
...
let _c_36=Lazy((_i) => {
  Force(_c_6);
  return class Event extends _c_6 {
    static {
      _c_36=_i(this);
    }
    name;
