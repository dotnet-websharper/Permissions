...
(function(Global)
{
 ...
 Client.Main=function()
 {
  ...
  function checkPermission(permissionName)
  {
   ...
   {
    return permissionStatus.Set(Global.String(permissionName)+" permission: "+Global.String(result.state));
   }))["catch"](function()
   {
  ...
  },function()
  {
   ...
   {
    return Concurrency.Bind(Promise.AsAsync(checkPermission("geolocation")),function()
    {
 ...
 WebSharper$Permissions$Sample_Templates.main=function(h)
 {
